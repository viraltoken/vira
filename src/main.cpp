...
const string strMessageMagic = "Viral Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 100) // VIRA
    {
        nSubsidy = 20000000 * COIN;
    }
    else if(pindexBest->nHeight < 129600) //   First 45 mining days approx to ensure network stability 16200000  
    {
        nSubsidy = 125 * COIN;
}
else if(pindexBest->nHeight < 720000) //   1446480000 approx minted after 8 months
    {
        nSubsidy = 2450 * COIN;
    }
...
return nSubsidy + nFees;
    ...
    else if(pindexBest->nHeight < 720001) // 
    {
    nSubsidy = 2000 * COIN;
return nSubsidy + nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Viral", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Viral Genesis";
        CTransaction txNew;
        txNew.nTime = 1558948830;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1558948830;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1127795;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x67aaddd9b56bd5c92fef98738b4a6be01e411d5a6d0880d1a6f51fb27fbde230"));
