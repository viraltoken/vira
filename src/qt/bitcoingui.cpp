	...
	stakeForCharityDialog(0)
{
    updateStyle();
    resize(1000, 740);
    setWindowTitle(tr("Viral") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Viral address"));
	...
	pioAction = new QAction(QIcon(":/icons/web"), tr("&Viral Website"), this);
	pioAction->setToolTip(tr("Visit the Official Viral website"));
	bitcointalkAction = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk Viral discussion thread"));
	twitterAction = new QAction(QIcon(":/icons/twitter"), tr("&@Viral"), this);
	twitterAction->setToolTip(tr("Visit the Official Viral Twitter"));	
	chainAction = new QAction(QIcon(":/icons/explorer"), tr("&Viral Slack"), this);
	chainAction->setToolTip(tr("Join Viral Slack"));	
	githubAction = new QAction(QIcon(":/icons/github"), tr("&Github"), this);
	githubAction->setToolTip(tr("Visit the Official Viral Github"));	
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Viral"), this);
    aboutAction->setToolTip(tr("Show information about Viral"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Viral"));
	...
	connect(twitterAction, SIGNAL(triggered()), this, SLOT(twitterClicked()));
	connect(chainAction, SIGNAL(triggered()), this, SLOT(chainClicked()));
	connect(githubAction, SIGNAL(triggered()), this, SLOT(githubClicked()));	
...
void BitcoinGUI::createMenuBar()
{
    ...
    resources->addAction(twitterAction);	
    resources->addSeparator();	
    resources->addAction(chainAction);
    resources->addSeparator();		
    resources->addAction(githubAction);	
...
void BitcoinGUI::createToolBars()
{
	...
	QToolBar *toolbar2 = addToolBar(tr("Viral top-logo"));
	...
	QToolBar *toolbar4 = addToolBar(tr("Viral side-logo"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Viral client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Viral client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the Viral network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(count < nTotalBlocks)
    {
        ...
        if (strStatusBarWarnings.isEmpty())
        {
            ...
            progressBarLabel->setVisible(false);
            progressBar->setFormat(tr("Synchronizing with the Viral network:   %n block(s) remaining", "", nRemainingBlocks));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Viral address or malformed URI parameters."));
    }
...
void BitcoinGUI::updateStyle()
{
    ...
    QString qssPath = QString::fromStdString( GetDataDir().string() ) + "/Viral.qss";
