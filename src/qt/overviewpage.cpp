    ...
    filter(0)
{
    ...
    ui->labelWalletStatus->setText("(" + tr("Out of sync with the Viral network") + ")");
    ui->labelTransactionsStatus->setText("(" + tr("Out of sync with the Viral network") + ")");
...
void OverviewPage::setModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("VIRA")
    updateDisplayUnit();
}
