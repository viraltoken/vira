...
void OptionsModel::Init()
{
    ...
    fUseViralTheme = settings.value("fUseViralTheme", true).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case UseViralTheme:
            return QVariant(fUseViralTheme);
        default:
            return QVariant();
        }
    }
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case UseViralTheme:
            fUseViralTheme = value.toBool();
            settings.setValue("fUseViralTheme", fUseViralTheme);
            break;
        default:
            break;
        }
